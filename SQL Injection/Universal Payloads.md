<div style="background-color:#f9f9f9; border-left: 4px solid #007acc; padding: 10px 15px; margin: 20px 0; font-family: 'Segoe UI', sans-serif; border-radius: 6px;">
  <strong>Note:</strong> Some payloads are taken from this page — 
  <a href="https://github.com/payloadbox/sql-injection-payload-list" target="_blank" style="color:#007acc; text-decoration:none;">
    https://github.com/payloadbox/sql-injection-payload-list
  </a><br>
  <strong>Credit:</strong> <span style="color:#333;">payloadbox</span>
</div>
